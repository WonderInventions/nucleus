 ...
 * same group when releasing them touches the same store keys:
 *
 * * every linux package goes through the one apt/yum repo per channel, whose
 *   metadata is regenerated by a whole-repo read-modify-write
